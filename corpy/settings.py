"""
Django settings for corpy project.
...
PROJECT_APPS = [
    'apps.base',
    # 'apps.contas', #foi colocado no DJANGO_APPS acima.
    'apps.perfil',
    'apps.pages',
]
...
WSGI_APPLICATION = 'corpy.wsgi.application'
...
SESSION_EXPIRE_SECONDS = 60 # 1800s = 30m depois de 30 minuts, a sessão expira
...
# STATICFILES_DIRS = [ # talvez em Produção pudesse usar assim.
# BASE_DIR / 'static',
# ]
